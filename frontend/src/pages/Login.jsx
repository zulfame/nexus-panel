          ...
          <form onSubmit={submit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="border-white/20 bg-transparent focus-visible:ring-1 focus-visible:ring-[var(--ds-primary)]"
            ...
            {error && (
              <div data-testid="login-error" className="border border-status-error/40 bg-status-error/10 px-3 py-2 text-xs text-status-error">
                {error}
              </div>
            )}
            ...
            <Button
              ...
              disabled={loading}
              className="w-full bg-[var(--ds-primary)] text-white hover:bg-[var(--ds-primary-hover)]"
            >
